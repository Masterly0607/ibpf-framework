<template>
    <q-page class="q-pa-md">
        <div class="ibf-container-1200">
            <div class="q-pa-none">
                <q-heading-1 title="Cart" subtitle="All items to checkout" icon="mdi-cart-variant"
                    showLine="true"></q-heading-1>
                ...
                <div v-else>
                    ...
                    <section v-else id="cart-item" class="column q-gutter-md q-mt-sm">
                        <q-card class="ibf-card-3" square v-for="(cartItem, itemIndex) in cartItems" :key="itemIndex">
                            <q-card-section class="q-pa-xs">
                                <q-item class="q-px-sm">
                                    <q-item-section side top>
                                        <q-checkbox color="red" v-model="selectedItems" :val="cartItem" />
                                    </q-item-section>
                                    <q-item-section>
                                        <div class="row q-gutter-sm">
                                            <div class="col-12 col-md-2 text-center">
                                                <img style="height: 150px; width: 150px; object-fit: cover"
                                                    class="rounded-borders" :src="cartItem.course.thumbnail" />
                                            </div>

                                            <div class="col-12 col-md">
                                                <q-item-label class="ibf-h9 text-weight-medium ellipsis-2-lines">
                                                    {{ cartItem.course.title }}
                                                </q-item-label>

                                                <div class="row q-gutter-x-md q-mt-md">
                                                    <icon-label icon="mdi-earth"
                                                        :title="cartItem.course.product_type.title" />

                                                    <icon-label icon="mdi-checkbox-blank-badge-outline"
                                                        :title="cartItem.course.core_area.title" />

                                                    <div>
                                                        <q-badge v-if="cartItem.course.is_free" color="secondary"
                                                            text-color="white" label="Free" />
                                                    </div>
                                                </div>

                                                <div class="q-mt-lg ibf-h9 text-teal" v-if="cartItem.course.is_free">
                                                    Free
                                                </div>

                                                <div class="q-mt-lg" v-else>
                                                    <price-original :currency="cartItem.course.currency"
                                                        :price="cartItem.course.price" :is-decimals="false" />

                                                    <div v-if="cartItem.course.isDiscount"
                                    ...
                                    <q-item-section side top>
                                        ...
                                        <q-btn flat size="12px" round color="red-5" icon="delete" @click="
                                            removeItem({
            ...
            <q-footer class="q-pa-md bg-white" bordered>
                <q-card flat class="footer-container q-mx-auto">
                    <div class="row justify-between items-center">
                        <div class="col-auto">
                            <q-checkbox :disable="isCartEmpty" color="red" v-model="isSelectedAll" true-value="true"
                                false-value="false" @update:model-value="() =>
                                    isSelectedAll == 'true'
                        ...
                        <div class="col-auto">
                            <div class="row q-gutter-x-md">
                                ...
                                <q-btn :disable="isCartEmpty" unelevated rounded color="red"
