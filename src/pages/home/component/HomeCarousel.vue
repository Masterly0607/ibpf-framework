<template>
    <section class="ibf-container-1200">
        <q-carousel v-model="slide" transition-prev="jump-right" transition-next="jump-left" swipeable animated
            control-color="primary" :height="autoHeightCarousel" padding class="bg-grey-2">
            <q-carousel-slide v-for="(dataUrl, index) in imageUrl" :key="index" :name="index + 1" class="q-pa-none">
                <q-img :src="dataUrl.img" height="100%" width="100%" fit="fill" spinner-color="primary"
                    spinner-size="82px" />
                ...
                <div class="absolute-bottom custom-caption q-pa-md">
                    <div class="row justify-between items-center">
                        ...
                        <div class="col-auto">
                            <q-btn flat rounded color="grey-10" icon-right="mdi-arrow-right-thin" @click="nextSlide"
                                no-caps label="More info" />
                        </div>
                    </div>
                </div>
            </q-carousel-slide>
