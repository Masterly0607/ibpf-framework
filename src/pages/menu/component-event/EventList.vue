<template>
  <div>
    ...
    <q-tab-panels animated v-model="tab" class="card-background-1">
      ...
      <!-- tab two -->
      <q-tab-panel name="TabTwo" class="q-pa-none q-py-lg">
        <div class="q-gutter-y-lg">
          <q-card
            class="ibf-card-3"
            v-for="(itemEvent, index) in eventData"
            ...
            <q-card-section>
              <div class="row q-col-gutter-md">
                ...
                <div class="col-12 col-md-9">
                  ...
                  <div
                    class="text-grey-8 text-weight-light multi-line-ellipsis"
                  >
                    {{ itemEvent.date }}
                  </div>
...
const eventData = ref([
  {
    id: 1,
    title:
      "Institute of Banking and Finance partnered with top universities to address skill gaps in the Cambodian financial sector ",
    date: "05-May-2024",
    location: "at IBF",
    // isActive: true,
    // router: "cart1",
...
const eventDetail = () => {
  router.push({ name: "event-detail-page" });
};
</script>
