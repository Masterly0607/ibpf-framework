<template>
  <div class="q-py-md">
    <!-- Title -->
    <div class="ibf-h8 text-weight-bold">IBF Management Team</div>
    <!-- Subtittle -->
    <div class="ibf-h11 text-weight-regular text-grey-7 q-py-md">
      Our Management Team of seasoned industry experts and visionary individuals <br>
      promotes innovation, integrity, and sustainable growth in the Cambodian banking sector through <br>
      leadership.
    </div>
